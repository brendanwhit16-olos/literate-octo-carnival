# Civics & Elections: The Exhaustion-Extraction Trap

> A problem situation mapped using Kees Dorst's Frame Creation method.
> Built from 10 cards covering 18 signals across the evidence ladder.
> Exported 2026-07-26T06:26:53.179Z.

## The situation
This is an open condition, not a bounded problem, because it represents an interconnected network of institutional friction, cognitive overload, administrative slowness, and extractive communication loops where every attempt at incremental reform or public engagement inadvertently reproduces the exhaustion that drives citizen exit.

### Why this is open, not bounded
What makes this open is that there is no single "broken component" or universally agreed-upon failure state. The network involves competing actors with misaligned incentives:
...
Why this is interesting: It frames civic effort as an unacknowledged economic and psychological extraction ("tax") levied on the participant's goodwill.
...
Problem: Exceptionally strong (Unscaffolded Civic Duty, Rigged Architecture of Choice, Binary Lock-In through Systemic Complexity).

Value: Moderate (Restructuring the Political System, No Playbook for Good Citizenship — capturing implicit desires for alternative governance models and civic clarity).

Boundary: Moderate (Campaign Finance, Structural Election Imbalances — defining statutory limits).

Thin or Absent:

History: Thin — lacks long-term context on how local civic infrastructure transitioned from high-accountability social networks (Loneliness as a Civic Problem) to isolated digital interactions.

Flux: Thin — lacks empirical data on emerging technological shifts beyond surface concerns about AI (Public Engagement on Government AI, AI Bot Interference).

Player: Very thin — captured purely from the victim/citizen perspective; lacks primary evidence from election administrators, campaign strategists, and municipal staff.

Counterfactual: Completely absent — no evidence exploring communities or international jurisdictions where civic scaffolding or binding public consultation successfully eliminated this friction.
...
Role 1: County Election Clerks and Deputy Registrars who handle ballot processing and voter inquiries directly.

Role 2: Outgoing PTA Presidents and Civic Club Chairs who quit leadership roles within the last 12 months due to burnout.

Role 3: Non-voting adults aged 18–35 in gerrymandered districts who have abstained from the last two election cycles.

### What I can't reach alone — and how I might
Need: Direct access to county election administrators and municipal staff to understand why feedback tools remain non-binding.

Possible Path: Submit formal inquiries or request short informational interviews via the National Association of State Election Directors (NASED) or local municipal clerk associations.

Need: Reaching intentionally disengaged, non-voting citizens (who do not attend town halls or respond to civic surveys).

Possible Path: Post recruitment screeners on hyper-local, non-political community channels (e.g., local Reddit subreddits, community bulletin boards, or Discord servers) offering compensation for non-voters to share their experiences.

---

## The paradox
The situation demands that everyday citizens expend extraordinary personal energy to decipher, organize, and reform an entrenched system, but the same unscaffolded complexity that creates this need consumes citizen energy through friction and burnout, guaranteeing individual attrition that preserves the status quo.

_Sharpness self-check (pod-declared): 3/3._

### Who benefits from the status quo
Actor: Incumbent Political Parties & Campaign Consultants.
...
No client handed us this problem — the evidence did. This paradox was read off **18 source extracts** across **2 named themes** (The Un-Scaffolded Tax on Civic Endurance, The Broken Covenant of Reciprocity). The full trail ships with this folder (`data/extracts.csv` + the themes narrative).

Representative extracts:
- "Campaign Finance & District Competitiveness" — Observations that financial influence and gerrymandering have reduced the competitiveness of congressional districts.
- "Restructuring the Political System" — A high-level desire to shift the fundamental political structure of the United States to model other international systems.

### What we're still testing
- What could break this framing: What is assumed: We assume that citizens possess a latent desire for civic participation and are merely blocked by "friction" and "missing playbooks," rather than recognizing that non-participation may be an intentional, rational refusal to legitimize extractive institutions.
...
What is assumed: We assume that citizens possess a latent desire for civic participation and are merely blocked by "friction" and "missing playbooks," rather than recognizing that non-participation may be an intentional, rational refusal to legitimize extractive institutions.
...
- **Local Volunteer Organizers & PTA Chairs** _(Wider field)_ — Personal time, emotional energy, community trust
- **Municipal Engagement Directors & Election Staff** _(Inner circle)_ — Administrative labor, statutory compliance, workplace retention	They manage the execution of public forums and ballots under severe resource constraints.
